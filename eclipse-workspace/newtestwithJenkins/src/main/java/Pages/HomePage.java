...
public class HomePage extends PageBase {
	...
	public HomePage(WebDriver driver) {
       ...
       @FindBy(id="product-collection-image-266147")
       WebElement firstIphone11;          
    
       @FindBy(xpath = "//*[@id=\"product-price-266147\"]/div[1]")
       WebElement Pricecheck ;
       
  
	public void UserSelect_ApplePhones() throws IOException
	{
		lANGUAGE.click();
		...
		iphone11Tap.click();
		firstIphone11.click();
		String PriceFoRIPHONE= Pricecheck.getText();
		System.out.println(PriceFoRIPHONE);
		Assert.assertTrue(PriceFoRIPHONE.contains("3699"));
...
/*
        ...
        public void testTakesScreenshot() throws IOException 
        {
        	...
        	FileUtils.copyFile(Source, new File("/newtestwithJenkins/Screenshot"));
